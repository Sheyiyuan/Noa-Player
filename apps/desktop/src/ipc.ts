...
export const noaDesktopClient: NoaDesktopApi = {
    ...
    closeWindow: (payload) => invokeIpc(() => window.noaDesktop.closeWindow(payload)),
    ...
    getTempNoteProject: () => invokeIpc(() => window.noaDesktop.getTempNoteProject()),
    saveTempNoteProject: (payload) => invokeIpc(() => window.noaDesktop.saveTempNoteProject(payload)),
    setNoteDirty: (payload) => invokeIpc(() => window.noaDesktop.setNoteDirty(payload)),
    setProjectVideos: (payload) => invokeIpc(() => window.noaDesktop.setProjectVideos(payload)),
    saveProjectAs: (payload) => invokeIpc(() => window.noaDesktop.saveProjectAs(payload)),
    listSaveDirectories: (payload) => invokeIpc(() => window.noaDesktop.listSaveDirectories(payload)),
    createSaveDirectory: (payload) => invokeIpc(() => window.noaDesktop.createSaveDirectory(payload)),
